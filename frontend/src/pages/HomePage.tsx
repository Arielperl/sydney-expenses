...
const faq: [string, string][] = [
  ['האם צריך להזין כל עסקה ידנית?', 'לא. לאחר חיבור מערכת התשלומים, עסקאות חדשות נקלטות אוטומטית. אפשר גם לייבא מכירות מקובץ או להוסיף מכירה ידנית בעת הצורך.'],
  ['מה המערכת עוזרת לי להבין?', 'רואים במקום אחד כמה נמכר, כמה מע״מ נגבה, אילו עמלות והחזרים נוכו ומה נשאר לאחר הניכויים. אפשר לזהות מגמות, עסקאות שדורשות טיפול ולשאול את עוזר ה־AI שאלות על נתוני העסק.'],
  ['האם אפשר להתחבר למערכת התשלומים שלי?', 'המערכת תומכת בחיבורים ישירים למערכות תשלום זמינות ובייבוא מכירות ממקורות נוספים. במהלך ההגדרה בוחרים את מקור המכירות, ואם נדרש חיבור נוסף אפשר לפנות לתמיכה מתוך המערכת.'],
  ['האם הנתונים של העסק שלי מוגנים?', 'כן. הכניסה למערכת מאובטחת, וכל חשבון עסקי מופרד כך שמשתמשים רואים רק את הנתונים והפעולות שההרשאה שלהם מאפשרת.'],
]
