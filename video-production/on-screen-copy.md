...
| 2 | **העסק מכר.** | The business made a sale. | 2.00 → 3.72 | 1.7 s (min 1.0) | Names the moment | Center, y 420 px | 700, 180 px | White; amounts behind dim to 25% | Stab + soft impact at 2.00 | Website hero |
...
| 5 | **פחות התעסקות.** / **יותר בהירות.** | Less hassle. / More clarity. | 8.30 → 9.85 | 1.55 s (min 1.4) | The turn; the brand's attitude | Right third: right 110 px, top 340 px, width 680 | 700, 84 px; line 2 mint `#41D7B2` | White/mint on deep green | THE DROP at 8.00 | Website eyebrow |
...
| 12 | **העסק מכר.** / **אתם כבר בתמונה.** | The business made a sale. / You're already in the picture. | 26.00 / 26.35 → end | 4.0 s | Promise; closes the loop opened by #2 | Center, top 300 → 240 px at 27.10 | 700, 120 px; "בתמונה." in mint | White/mint on dimmed panels (radial darkening 60%) | Piano chord 26.00 | Website hero |
