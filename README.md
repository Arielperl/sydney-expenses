...
- **Data Import** — the Grow/Cardcom connection panels selected for this business during onboarding, plus CSV sales-export import with preview and explicit confirmation. Adding another payment provider later is a platform-admin/support action and is enforced by the API as well as the UI.
